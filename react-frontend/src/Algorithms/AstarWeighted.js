...
export function wastar(grid, startNode, goalNode, weightValue){
  weight = weightValue;
...
function sortNodesByDistanceHeuristic(unvisitedNodes, endNode){
  unvisitedNodes.sort((nodeA, nodeB)=> (nodeA.distance + weight*heuristic(nodeA, endNode)) - (nodeB.distance + weight*heuristic(nodeB, endNode)))
}
